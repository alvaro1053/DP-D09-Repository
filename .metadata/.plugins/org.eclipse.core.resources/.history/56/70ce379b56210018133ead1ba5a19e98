...
<form:form action="service/user/request.do" modelAttribute="request">
	<form:hidden path="id" />
	<form:hidden path="version" />
	<form:hidden path="service" />
	
	
<spring:message code="service.choose.rende" var="rende"  />
<acme:select items="${principal.rendes}" itemLabel="name" code="${rende}" path="rende"/>
<br/>
